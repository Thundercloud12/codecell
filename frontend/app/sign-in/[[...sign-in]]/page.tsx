  ...
  return (
    <div className="min-h-screen w-full bg-[#0A0F1A] overflow-hidden flex font-sans text-[#E5E7EB] selection:bg-[#22C55E]/20">
      ...
      <div className="fixed inset-0 z-0 pointer-events-none">
        ...
        <div className="absolute bottom-[-10%] right-[20%] w-[30%] h-[30%] bg-[#2DD4BF]/10 rounded-full blur-[100px]" />
      </div>
      ...
      <div className="relative z-10 w-full lg:w-[45%] flex flex-col justify-center px-8 lg:px-24">
        ...
        >
          <div className="mb-10">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#141B2A] border border-[#22C55E]/30 mb-6">
          ...
          <div className="bg-[#141B2A]/70 backdrop-blur-xl border border-[#1F2937] p-1 rounded-3xl shadow-2xl shadow-black/50">
            <SignIn
              ...
              appearance={{
                elements: {
                  formButtonPrimary:
                    "bg-[#22C55E] hover:bg-[#22C55E]/80 text-black font-semibold rounded-xl shadow-lg shadow-[#22C55E]/20 transition-all active:scale-[0.98] py-3.5 text-sm",
                  card: "shadow-none border-0 bg-transparent p-6",
                  headerTitle: "hidden",
                  headerSubtitle: "hidden",
                  socialButtonsBlockButton:
                    "border border-[#1F2937] hover:border-[#22C55E]/50 hover:bg-[#22C55E]/10 rounded-xl py-2.5 transition-all text-[#9CA3AF] font-medium text-sm",
                  formFieldInput:
                    "px-4 py-3 bg-[#0A0F1A] border border-[#1F2937] rounded-xl focus:border-[#22C55E] focus:ring-4 focus:ring-[#22C55E]/10 outline-none transition-all placeholder:text-[#9CA3AF] text-[#E5E7EB] text-sm",
                  formFieldLabel: "text-[#9CA3AF] font-medium text-sm mb-1.5",
                  footerActionLink:
                    "text-[#22C55E] hover:text-[#2DD4BF] font-medium",
                },
              }}
            />
          </div>
      ...
      <div className="hidden lg:block w-[55%] relative overflow-hidden bg-[#141B2A] m-4 rounded-[2.5rem] border border-[#1F2937]">
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1480714378408-67cf0d13bc1b?auto=format&fit=crop&q=80&w=2053')] bg-cover bg-center opacity-20 mix-blend-overlay"></div>
        <div className="absolute inset-0 bg-gradient-to-br from-[#22C55E]/10 to-[#0A0F1A]/90"></div>

        {/* Decorative Overlay */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-[#22C55E]/10 rounded-full blur-[120px]"></div>
        ...
        <div className="relative z-10 h-full flex flex-col justify-between p-16 text-white">
          ...
          <div>
            <blockquote className="text-3xl font-medium leading-normal mb-8 text-[#E5E7EB]">
              "Smart infrastructure management powered by AI detection and real-time geospatial tracking."
            </blockquote>
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 rounded-full border-2 border-[#22C55E]/30 overflow-hidden bg-[#22C55E]/20 flex items-center justify-center">
                <ShieldCheck className="w-6 h-6 text-[#22C55E]" />
              </div>
              <div>
                <div className="font-semibold text-[#E5E7EB]">Secure Platform</div>
