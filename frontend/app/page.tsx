  ...
  return (
    <div className="min-h-screen bg-[#F8F6F1] text-[#1E3A5F] overflow-hidden relative selection:bg-[#1E3A5F] selection:text-white font-sans">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute bottom-[-20%] right-[-10%] w-[500px] h-[500px] rounded-full bg-[#2E7D32] opacity-[0.06] blur-[100px] animate-pulse" style={{ animationDelay: '2s' }}></div>
      </div>
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 py-20">
        ...
        >
          ...
          <h1 className="text-5xl md:text-7xl font-bold mb-8 tracking-tight leading-none text-[#1E3A5F]">
            Smart <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#2E7D32] to-[#1565C0]">Cities</span>.
            <br />
            Better <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#1565C0] to-[#2E7D32]">Roads</span>.
          </h1>
          
          <p className="text-lg md:text-xl text-[#5A6C7D] mb-12 max-w-3xl mx-auto leading-relaxed">
            Modern infrastructure management powered by <span className="text-[#1E3A5F] font-semibold">AI detection</span> and <span className="text-[#1E3A5F] font-semibold">real-time tracking</span> — helping keep your city safe and roads maintained.
          </p>
        ...
        <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl w-full px-4">
          {[
            ...
            >
              <div className={`w-16 h-16 ${feature.iconBg} rounded-xl flex items-center justify-center text-3xl mb-6 group-hover:scale-110 transition-transform duration-300`}>
                {feature.icon}
              </div>
