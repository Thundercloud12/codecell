  ...
  () => import("@/components/PotholeLocationMap"),
  {
    ...
    loading: () => (
      <div className="h-64 bg-[#0B1220] rounded-xl border border-[#1F2937] flex items-center justify-center">
        <div className="text-[#00E676] font-mono animate-pulse">
  ...
  return (
    <div className="min-h-screen bg-[#050B16] text-white p-6 font-sans">
      <div className="max-w-7xl mx-auto">
        <Link
          href="/potholes"
          className="text-[#00B8D4] mb-8 inline-flex items-center gap-2 hover:text-[#00E676] transition font-mono text-sm uppercase tracking-wider"
        >
          ← Return to Registry
        </Link>
        ...
        <div className="flex justify-between items-start mb-8 border-b border-[#1F2937] pb-6">
          ...
          <div className="text-right hidden md:block">
            <div className="text-[#94A3B8] text-[10px] font-mono uppercase">
              System Status
            </div>
            <div className="text-[#00E676] font-bold tracking-widest animate-pulse">
              ONLINE
            </div>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-6 mb-8">
          ...
          <div className="lg:col-span-1 space-y-6">
            <div className="bg-[#0B1220] border border-[#1F2937] rounded-xl p-6 relative overflow-hidden">
              <div className="absolute top-0 right-0 p-2 opacity-20">
                <svg
                  className="w-12 h-12 text-[#00B8D4]"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
              ...
              <h3 className="text-[#94A3B8] text-xs font-bold uppercase tracking-widest mb-4">
                Telemetry
              </h3>

              <div className="space-y-4">
                <div>
                  <label className="text-[10px] text-[#94A3B8] font-mono uppercase">
                    Geo Coordinates
                  </label>
                ...
                <div>
                  ...
                  <div className="font-mono text-[#00E676] text-lg">
            ...
            <div className="bg-[#0B1220] border border-[#1F2937] rounded-xl p-6">
              ...
              {pothole.priorityScore !== null && pothole.priorityLevel ? (
                ...
                <div className="text-center py-4">
                  <p className="text-[#94A3B8] text-xs font-mono mb-4 italic">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-[#0B1220] border border-[#1F2937] rounded-xl p-6">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div className="relative group">
                  <div className="absolute top-2 left-2 bg-black/60 backdrop-blur px-2 py-1 rounded text-[10px] font-mono text-white border border-white/10">
                    RAW_INPUT
                  </div>
                  {pothole.imageUrl ? (
                    <img
                ...
                {/* Processed */}
                <div className="relative group">
                  <div className="absolute top-2 left-2 bg-[#00E676]/20 backdrop-blur px-2 py-1 rounded text-[10px] font-mono text-[#00E676] border border-[#00E676]/30 z-10">
                    AI_OVERLAY
                  </div>
                  {pothole.imageUrl ? (
            ...
            {/* Map & Context */}
            <div className="bg-[#0B1220] border border-[#1F2937] rounded-xl p-6">
              <h2 className="text-[#94A3B8] text-xs font-bold uppercase tracking-widest mb-4">
                Location Context
              </h2>
              ...
              {pothole.roadInfo ? (
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 pt-4 border-t border-[#1F2937]">
                  ...
                  <div>
                    ...
                    <div className="text-[#00B8D4] font-bold font-mono text-sm">
                  ...
                  <div>
                    ...
                    <div className="text-[#FFC400] font-bold font-mono text-sm">
          ...
          {pothole.ticket ? (
            <div className="flex items-center gap-6 p-4 bg-[#050B16] rounded border border-[#1F2937]">
              <div>
                ...
                <div className="font-mono text-white text-xl tracking-wider">
              ...
              <div>
                ...
                <div className="text-[#00E676] font-bold uppercase">
              ...
              <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                ...
                <div className="flex gap-3">
                  <button
                    ...
                    className="bg-[#00B8D4] text-black border border-[#00B8D4] px-6 py-4 rounded font-bold hover:bg-[#00B8D4]/80 disabled:opacity-50 transition uppercase tracking-widest text-sm shadow-[0_0_20px_rgba(0,184,212,0.3)] hover:shadow-[0_0_30px_rgba(0,184,212,0.5)]"
                  >
