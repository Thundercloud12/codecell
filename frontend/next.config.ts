        ...
        headers: [
          {
            ...
            value: [
              ...
              "connect-src 'self' https://*.clerk.accounts.dev https://clerk.accounts.dev https://*.clerk.dev https://clerk-telemetry.com https://*.neon.tech wss://*.neon.tech http://localhost:8000 http://127.0.0.1:8000 https://challenges.cloudflare.com https://router.project-osrm.org",
              "style-src 'self' 'unsafe-inline'",
              "img-src 'self' data: blob: https://*.clerk.dev https://*.clerk.accounts.dev https://img.clerk.com https://images.clerk.dev https://*.googleusercontent.com https://*.gravatar.com https://res.cloudinary.com https://*.openstreetmap.org https://*.tile.openstreetmap.org https://*.basemaps.cartocdn.com https://*.carto.com https://images.unsplash.com https://unpkg.com",
              "font-src 'self' data:",
