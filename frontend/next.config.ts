        ...
        headers: [
          {
            ...
            value: [
              ...
              "img-src 'self' data: blob: https://*.clerk.dev https://*.clerk.accounts.dev https://img.clerk.com https://images.clerk.dev https://*.googleusercontent.com https://*.gravatar.com https://res.cloudinary.com https://*.openstreetmap.org https://*.tile.openstreetmap.org",
              "font-src 'self' data:",
