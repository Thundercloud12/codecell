                ...
                <div className="p-3 min-w-[250px] bg-white rounded-lg">
                  ...
                  <div className="space-y-2 text-sm">
                    <div className="flex items-center gap-2">
                      <span className="font-medium text-[#5A6C7D]">Status:</span>
                      <span
                    ...
                    {hasDetection && (
                      <div className="flex items-center gap-2">
                        <span className="font-medium text-[#5A6C7D]">AI Detected:</span>
                    ...
                    {report.severity && (
                      <div className="flex items-center gap-2">
                        <span className="font-medium text-[#5A6C7D]">Severity:</span>
